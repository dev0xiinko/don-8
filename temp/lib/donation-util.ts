...
import { makeDonation, makeTokenDonation } from "./contract-utils"
...
export const sendDonation = async (
  ...
  try {
    ...
    // Use the contract to make the donation
    const result = await makeDonation(recipientAddress, amount, isAnonymous)
...
// New function to send token donations
export const sendTokenDonation = async (
  walletInfo: any,
  recipientAddress: string,
  tokenAddress: string,
  amount: string,
  ...
  try {
    ...
    // Use the contract to make the token donation
    const result = await makeTokenDonation(recipientAddress, tokenAddress, amount, isAnonymous)
...
export const formatTransactionUrl = (txHash: string, network = "Base Sepolia"): string => {
