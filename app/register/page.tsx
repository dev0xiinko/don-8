    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
        <Card className="max-w-lg w-full text-center shadow-xl border-0">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-emerald-700">Application Submitted</CardTitle>
            <CardDescription className="text-gray-600">
              Please check your email for any updates regarding your application.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Link href="/">
      ...
      <div className="container mx-auto max-w-2xl">
        ...
        <Card className="shadow-xl border-0 bg-white">
          <CardHeader className="text-center pb-8 bg-gradient-to-r from-emerald-50 to-green-50 rounded-t-lg">
            <CardTitle className="text-2xl font-bold text-gray-900 mb-3 pt-4">NGO Registration</CardTitle>
